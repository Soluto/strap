...
Dependencies:
<ol>
	<li>Github account with dotfiles repository. You can start by forking an <a href="https://github.com/oryagel/dotfiles">existing repository</a></li>
	<li>Apple Id for the Mac App store</li>
</ol>
</br>
